...
{{-- <head>
	...
	<link rel="stylesheet" href="{{ asset('canvas/demos/furniture/furniture.css') }}" type="text/css" /> 
	<link rel="stylesheet" href="{{ asset('canvas/demos/furniture/css/fonts.css') }}" type="text/css" /> 
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('canvas/include/rs-plugin/css/settings.css') }}" media="screen" />
