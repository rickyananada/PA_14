<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
    ...
    <tbody class="fw-bold text-gray-600">
        ...
        <tr>
            ...
            {{-- <td class="text-end">
                <a href="javascript:;" onclick="load_input('#');" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                ...
                <a href="javascript:;" onclick="handle_confirm('#');" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                    <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
