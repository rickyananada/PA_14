                        ...
                        <div class="checkbox-form">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="order-notes mt-3">
                                    <div class="col-lg-6 col-custom">
                                        <div class="checkout-form-list checkout-form-list-4">
                                            ...
                                            <textarea id="checkout-mess" cols="50" rows="30"
                                                placeholder="harap gunakan bahasa yang sopan"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="order-button-payment">
                                    <div class="col-lg-6 col-custom">
                                        <button
                                            class="btn flosun-button secondary-btn black-color rounded-0 w-100">Kirim</button>
                                    </div>
                                </div>
                            </div>
                        </div>
